...
* Un modèle individu-centré spatialement explicite simulant les populations de lynx sur 50 ans par des données d’écologie comportementale et de dynamique des populations sur le lynx et permettant d’extraire des indices renseignant la viabilité des populations.
* Une interface interactive pour permettent aux utilisateurs non-spécialistes de facilement utiliser l’outil.  
